...
barplot[10].set_color('g')
barplot[9].set_color('g')
barplot[8].set_color('yellow')
barplot[7].set_color('yellow')
barplot[6].set_color('b')
barplot[5].set_color('b')
barplot[4].set_color('r')
barplot[3].set_color('r')
barplot[2].set_color('black')
barplot[1].set_color('black')
barplot[0].set_color('black')
